  ...
  return (
    <div className="max-w-screen-2xl container xl:px-28 px-4 py-16">
      ...
      <div className="flex flex-col md:flex-row items-center gap-4 mt-8">
        ...
        <div>
          <Link to="/">
            <img src="/images/category/image1.jpg" alt="" className="w-full hover:scale-105 transition-all duration-200" />
          </Link>
        </div>
        <div className="md:w-1/2">
          <div className="grid grid-cols-2 gap-2">
            <Link to="/">
              <img
                src="/images/category/image2.jpg"
                alt=""
            ...
            <Link to="/">
              <img
                src="/images/category/image3.jpg"
                alt=""
                className="hover:scale-105 transition-all duration-200"
              />
            </Link>
            <Link to="/">
              <img
                src="/images/category/image4.jpg"
                alt=""
                className="hover:scale-105 transition-all duration-200"
              />
            </Link>
            <Link to="/">
              <img
                src="/images/category/image5.jpg"
                alt=""
                className="hover:scale-105 transition-all duration-200"
              />
            </Link>
