    ...
    <div className="bg-primaryBG py-12 xl:px-28 px-4">
      ...
      <div className="md:w-1/2">
        ...
        <div className="md:w-1/2 w-full">
          ...
          You can explore and acquire a variety of unique collections from different brands here. 
          Find distinctive pieces that reflect your style on this platform!
          </p>
