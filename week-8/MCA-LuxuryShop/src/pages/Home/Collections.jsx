    ...
    <div className='bg-[url("/images/collection-bg.png")] bg-cover bg-center bg-no-repeat xl:px-28 px-4 my-20'>
      <div className=" h-[580px]  flex justify-betweenflex-col md:flex-row items-center">
        ...
        <div className="md:w-1/2">
          ...
          Embark on a journey of Zara dazzling elegance. 
          Hidden grace in every detail converges with unique designs.
           Infuse a touch of this magnificent collection awaiting you into your style!
          </p>
