            ...
            <div className="grid gird-cols-1 md:grid-cols-3 sm:grid-cols-2 gap-6 h-max">
              ...
              <div className="flex flex-col justify-between">
                <div>
                  ...
                  Take a step into an experience that defies boundaries.
                   We present luxury not just as a mere shopping spree but as a lifestyle. 
                   Enter the limitless world of prestigious brands and elegance. 
                   Each product is crafted with impeccable details, offering a magnificent fusion of 
                   design and sophistication. This is not just about shopping;
                    it is an opportunity to redefine your own style. We elevate luxury to the next level.
                     Express yourself, create unforgettable moments, and discover the luxury of your dreams.
                  </p>
                  {/* Star Ratings */}
